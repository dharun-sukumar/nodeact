...
function Footer() {
    return (
        <div className="lg:h-[90vh] md:h-[50vh] relative bg-[#FFC11F] px-8 pt-16">
            <div className="flex h-full items-end justify-between">
                <div className=" h-full">
                    <div className="flex flex-col h-[90%] justify-between">
                        <p className="z-50 text-black 2xl:text-9xl lg:text-7xl md:text-5xl">Nodeact</p>
                        <div className="flex items-center pb-10 lg:pb-0">
                            <p className="text-black 2xl:text-8xl lg:text-6xl md:text-4xl ">Let's Talk </p>
                ...
                <div className="flex justify-end 2xl:mb-32 lg:mb-20 md:mb-24">
                    <img src={logo} alt="" className="2xl:h-auto lg:h-52 md:h-40" />
                </div>
            </div>
        </div>
    );
